...
public class DonarForm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            if (view instanceof TextView) {
                view.setOnClickListener(v -> {
                    ...
                    for (int j = 0; j < grid.getChildCount(); j++) {
                        grid.getChildAt(j).setBackgroundResource(R.drawable.bg_blood_box);
                    }
        ...
        submitBtn.setOnClickListener(v -> {
            ...
            String hospital = hospitalText.getText().toString().trim();
            ...
            //  Create Model
            DonationReqModel model = new DonationReqModel(
                    selectedBloodType,
                    hospital,
                    location,
                    notes,
